...
import { ArrowRight, BookOpen, DollarSign, ShieldCheck, Truck } from 'lucide-react';
...
const features = [
  {
    ...
    description: 'Thousands of pre-loved books across all genres',
  },
  {
    icon: DollarSign,
    title: 'Great Prices',
    description: 'Save up to 70% compared to new books',
  },
  {
    icon: ShieldCheck,
  ...
  },
  {
    icon: Truck,
    title: 'Easy Shipping',
    description: 'Convenient delivery or local pickup options',
  },
];
    ...
    <Layout>
        ...
        <div className="container-booksnap relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-serif font-bold text-foreground animate-fade-in">
              Discover Your Next
              <span className="block text-primary mt-2">Favorite Read</span>
            </h1>
            <p className="mt-6 text-lg text-muted-foreground max-w-xl mx-auto animate-fade-in" style={{ animationDelay: '0.1s' }}>
              Buy and sell pre-loved books in your cozy corner of the internet. 
              Great stories deserve a second chapter.
            </p>
      ...
      <section className="py-16 lg:py-24 bg-muted/50">
        <div className="container-booksnap">
          <div className="flex items-center justify-between mb-10">
            <div>
              <h2 className="text-3xl font-serif font-bold text-foreground">Featured Books</h2>
      ...
      <section className="py-20 lg:py-28">
        <div className="container-booksnap">
          <div className="relative bg-gradient-to-br from-sage to-sage-dark rounded-3xl p-10 lg:p-16 text-center overflow-hidden">
            ...
            <div className="absolute top-1/2 right-20 w-12 h-18 bg-primary-foreground/5 rounded-lg rotate-6" />

            <div className="relative z-10">
              <h2 className="text-3xl lg:text-4xl font-serif font-bold text-primary-foreground">
                Have Books to Sell?
              </h2>
              <p className="mt-4 text-lg text-primary-foreground/80 max-w-xl mx-auto">
                Turn your old books into cash. List them in minutes and reach thousands of book lovers.
              </p>
              <Button
                variant="secondary"
                size="xl"
                asChild
                className="mt-8 bg-primary-foreground text-sage-dark hover:bg-primary-foreground/90"
              >
                <Link to="/sell">
                  Start Selling Today
                  <ArrowRight className="ml-2 h-5 w-5" />
